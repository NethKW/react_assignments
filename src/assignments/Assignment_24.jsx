  ...
  return (
    <div className="main asg-24">
      ...
      {!imageURL && (
        ...
        <p className="cursor animation" >Welcome to the Image Crop Tool! First, upload an image.
          Then, click the Crop button to select and crop the desired area of your image.</p></div>
      )}
